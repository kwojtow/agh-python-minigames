...
class Volleyball:
    def __init__(self, player_nmbr, network):
        self.images = ['Volleyball_Assets/pol.png', 'Volleyball_Assets/rus.png']
        self.playersX = [0, 0]
        self.playersY = [0, 0]
        ...
        self.ballRadius = 25
        self.ballX = self.width / 2 - self.ballRadius + 100
        ...
        self.playersImg[self.player_nmbr ] = pygame.transform.scale(self.playersImg[self.player_nmbr ], (2 * self.playersRadius[self.player_nmbr], 2 * self.playersRadius[self.player_nmbr]))
        ...
        self.playersImg[(self.player_nmbr + 1) % 2] = pygame.transform.scale(self.playersImg[(self.player_nmbr + 1) % 2], (2 * self.playersRadius[(self.player_nmbr + 1) % 2], 2 * self.playersRadius[(self.player_nmbr + 1) % 2]))
        self.playersYSpeed[(self.player_nmbr + 1) % 2] = 0
        self.playersXSpeed[(self.player_nmbr + 1) % 2] = 0
        self.playersMask[(self.player_nmbr + 1) % 2] = pygame.mask.from_surface(self.playersImg[(self.player_nmbr + 1) % 2])
        self.enemyPoints = 0
    ...
    def initialize_payers(self):
        ...
        self.playersX = [self.width * 3 / 4 - self.playersRadius[self.player_nmbr], self.width / 4 - self.playersRadius[(self.player_nmbr + 1) % 2]]
        self.playersY = [self.height * 3 / 4 - self.playersRadius[self.player_nmbr], self.height * 3 / 4 - self.playersRadius[(self.player_nmbr + 1) % 2]]
        self.playersXSpeed = [0, 0]
        self.playersYSpeed = [0, 0]
        self.playersImg = [self.images[self.player_nmbr], self.images[(self.player_nmbr + 1) % 2]]
        self.playersMask = [pygame.mask.from_surface(self.playersImg[self.player_nmbr]), pygame.mask.from_surface(self.playersImg[(self.player_nmbr + 1) % 2])]
    ...
    def check_collision(self):
        ...
        if self.playersMask[self.player_nmbr].overlap(self.ballMask, offset):
            offset_tmp = (int(self.ballX - self.playersX[self.player_nmbr]), int(self.ballY - self.playersY[self.player_nmbr]))
            while self.playersMask[self.player_nmbr].overlap(self.ballMask, offset_tmp):
                if self.ballX + self.ballRadius < self.playersX[self.player_nmbr] + self.playersRadius[self.player_nmbr]:
                    self.ballX -= 0.01
                if self.ballX + self.ballRadius > self.playersX[self.player_nmbr] + self.playersRadius[self.player_nmbr]:
                    self.ballX += 0.01
                if self.ballY + self.ballRadius < self.playersY[self.player_nmbr] + self.playersRadius[self.player_nmbr]:
                    self.ballY -= 0.01
                if self.ballY + self.ballRadius > self.playersY[self.player_nmbr] + self.playersRadius[self.player_nmbr]:
                    self.ballY += 0.01
                offset_tmp = (int(self.ballX - self.playersX[self.player_nmbr]), int(self.ballY - self.playersY[self.player_nmbr]))
        ...
        offset_enemy = (int(self.ballX - self.playersX[(self.player_nmbr + 1) % 2]), int(self.ballY - self.playersY[(self.player_nmbr + 1) % 2]))

        if self.playersMask[self.player_nmbr].overlap(self.ballMask, offset_enemy):
            offset_tmp = (int(self.ballX - self.playersX[(self.player_nmbr + 1) % 2]), int(self.ballY - self.playersY[(self.player_nmbr + 1) % 2]))
            while self.playersMask[(self.player_nmbr + 1) % 2].overlap(self.ballMask, offset_tmp):
                if self.ballX + self.ballRadius < self.playersX[(self.player_nmbr + 1) % 2] + self.playersRadius[(self.player_nmbr + 1) % 2]:
                    self.ballX -= 0.01
                if self.ballX + self.ballRadius > self.playersX[(self.player_nmbr + 1) % 2] + self.playersRadius[(self.player_nmbr + 1) % 2]:
                    self.ballX += 0.01
                if self.ballY + self.ballRadius < self.playersY[(self.player_nmbr + 1) % 2] + self.playersRadius[(self.player_nmbr + 1) % 2]:
                    self.ballY -= 0.01
                if self.ballY + self.ballRadius > self.playersY[(self.player_nmbr + 1) % 2] + self.playersRadius[(self.player_nmbr + 1) % 2]:
                    self.ballY += 0.01
                offset_tmp = (int(self.ballX - self.playersX[(self.player_nmbr + 1) % 2]), int(self.ballY - self.playersY[(self.player_nmbr + 1) % 2]))
        ...
        while self.net.current_minigame() == 6:
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_UP and self.playersY[self.player_nmbr] >= self.height - 100 - 2 * self.playersRadius[self.player_nmbr]:
            ...
            if (self.playersX[self.player_nmbr] <= self.width / 2 + 10 and self.playersXSpeed[self.player_nmbr] < 0) or (
                    self.playersX[self.player_nmbr] + 2 * self.playersRadius[self.player_nmbr] >= self.width and self.playersXSpeed[self.player_nmbr] > 0):
                self.playersXSpeed[self.player_nmbr] = 0
            ...
            # if self.player_nmbr == 0:
            self.net.send((6, (self.playersX[self.player_nmbr], self.playersY[self.player_nmbr], self.playersXSpeed[self.player_nmbr], self.playersYSpeed[self.player_nmbr]),
